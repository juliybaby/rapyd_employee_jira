...
$result = $db->prepare('SELECT * FROM employees where id =:id and user_token =:user_token');
...
<b>Departments:</b> <?php echo $department; ?><br>

<b style='font-size:16px;color:purple'>Salary: <?php echo $salary; ?> (USD)</b><br>
