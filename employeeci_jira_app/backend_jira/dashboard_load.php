...
$res= $db->prepare("SELECT count(*) as totalcount FROM employees where creator_id=:creator_id order by id");
...
$result = $db->prepare("SELECT * FROM employees where creator_id=:creator_id order by id DESC limit :row1, :rowpage");
