...
$res= $db->prepare("SELECT count(*) as totalcount FROM salary_emp_rapyd where creator_id=:creator_id and user_id =:user_id order by id");
...
$result = $db->prepare("SELECT * FROM salary_emp_rapyd where creator_id=:creator_id  and user_id =:user_id  order by id DESC limit :row1, :rowpage");
