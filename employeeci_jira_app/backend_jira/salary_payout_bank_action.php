...
if($payout_status =='Created'){
	/*
create table salary_emp_rapyd(id int primary key auto_increment,photo varchar(200),fullname varchar(100),department varchar(30),
user_token varchar(200), user_id varchar(30),payout_id varchar(200),payout_status varchar(20),timing varchar(30),
payment_type1 varchar(100),payment_type2 varchar(100),
salary_amount varchar(30), month_date varchar(50),month_period varchar(50),data varchar(50),creator_id varchar(50) );

alter table salary_emp_rapyd add column user_ewallet_id varchar(200);
*/


$resulta = $db->prepare('SELECT * FROM employees where creator_id = :creator_id and user_token= :user_token and id=:id');
...
/*
if($rec_List1a  == 0){
echo "<div style='background:red;color:white;padding:10px;border:none'>E,mployees Info not Found.</div>";
}
*/
$rowsa = $resulta->fetch();
$photo = $rowsa['photo'];
...
$statement = $db->prepare('INSERT INTO salary_emp_rapyd
...
month_period,creator_id,user_ewallet_id,recipient_id,sender_name,sender_photo)
