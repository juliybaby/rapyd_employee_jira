...
$result1 = $db->prepare('SELECT * FROM employees where email = :email');
...
$statement = $db->prepare('INSERT INTO employees
...
echo "<div id='alertdata_uploadfiles_o' class='well alerts alert-success'>Employee Created Successfully.
