...
$res = $db->prepare('SELECT * FROM employeers_bankinfo WHERE creator_id=:creator_id');
$res->execute(array(
...
$result = $db->prepare('SELECT * FROM employees WHERE creator_id=:creator_id and user_token=:user_token and id=:id');
